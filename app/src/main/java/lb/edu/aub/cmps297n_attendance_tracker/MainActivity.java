 ...
 * communicating with a back-end server to store accounts and attendees info is beyond the scope of this course,
 * we'll simulate this using the device's local storage as we will be applying what we learnt about data persistence
